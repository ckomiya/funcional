...
/**
 * Es una prueba unitaria define un tipo de arbol simple, con un valor en cada
 * nodo, y subarboles izquierdo y derecho. El tipo de arbol define un metodo
 * toString recursivo que recorre el arbol y construye una cadena desde cada
 * nodo. 
 * 
 * @author shredder
 * 
